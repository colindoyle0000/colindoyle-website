...
Class preparation is required. I expect that you will come to class having completed any readings or assignments and ready to speak about the materials assigned for that day.

## Laptop and Electronics Policy
Of course, we'll be using our computers for in-class exercises, but I will ask you to close your laptops for the discussion portions of the class. I have found that engagement with each other improves tremendously when screens are not (quite literally) between us. This is not a strict ban — maybe something comes up in the discussion that you want to look up quickly and share with the class. That's fine. But our laptops should generally be closed during class discussion.


## Generative AI Policy

We will develop the Generative AI policy for this course together.
